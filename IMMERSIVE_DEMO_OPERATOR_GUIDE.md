> This guide covers the retained standalone ALVR/SteamVR demo. For the native
> ILLIXR Quest app, use [README.md](README.md).
...
~~~bash
cd /path/to/alvr_streamer_linux/bin
./alvr_dashboard
~~~
...
required `boba-cu132` environment automatically; the operator does not need
to activate it.
